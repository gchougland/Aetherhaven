---
name: Festivals
description: Holidays your town celebrates on the festival square
author: Hexvane
---

# Festivals

Build a **festival square** and your town gets a place to celebrate. Most days it is a quiet plaza with benches. On a festival day the whole square changes into that festival's build, and it changes back when the day is done.

## Getting a festival square

Corin at the inn asks for one once the park is done. Take his token, place the festival square like any other plot, and let it finish building. It counts as a fun spot all year, so townsfolk and visitors come by even when nothing special is happening.
...
The square is looked after by the town, so nobody can dig it up or build on it. You can still use everything on it and harvest anything growing there. Keep your own decorations outside the plot.
