---
name: Механіка
description: "Інструменти, будівлі та міські системи"
author: Hexvane
sub-topics:
  - mechanic_commands
...
На цих сторінках описано, як кожна основна функція працює. Відкрийте потрібну вам сторінку зі списку ліворуч.
