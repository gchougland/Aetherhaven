...
public final class PathNavTravelSupport {
    /**
     * Intermediate path nodes accept sooner than the final POI leash so Seek does not linger on every node.
     * Final arrive uses {@code VillagerAutonomySystem} / travel instruction Leash Range (0.5).
     */
    public static final double INTERMEDIATE_WAYPOINT_ARRIVE_HORIZONTAL = 0.85;
