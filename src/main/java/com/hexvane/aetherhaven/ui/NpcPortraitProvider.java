...
public final class NpcPortraitProvider {
    ...
    private static final Map<String, String> ROLE_ID_TO_FILE = Map.ofEntries(
        ...
        Map.entry(AetherhavenConstants.NPC_CLOWN, "Aetherhaven_Clown.png"),
        Map.entry(AetherhavenConstants.NPC_FLORIST, "Aetherhaven_Florist.png"),
        Map.entry(AetherhavenConstants.NPC_FURNITURE_MERCHANT, "Furniture_Merchant.png"),
        ...
        Map.entry(AetherhavenConstants.NPC_FESTIVAL_WINTERTIDE_MERCHANT, "Aetherhaven_Festival_Wintertide_Merchant.png"),
        Map.entry(AetherhavenConstants.NPC_FESTIVAL_SNOWBALL_MERCHANT, "Aetherhaven_Festival_Snowball_Merchant.png"),
