...
import com.hexvane.aetherhaven.villager.TownVillagerNpcWorldSpawnSanitizeUtil;
...
/** Clears ambient despawn linkage for world NPCs (same rules as town villagers). */
public final class WorldNpcSanitizeSystems {
    private WorldNpcSanitizeSystems() {}
    ...
    public static final class OnAdd extends RefSystem<EntityStore> {
        ...
        @Nonnull
        private final Query<EntityStore> query = Query.and(WorldNpcBinding.getComponentType(), NPCEntity.getComponentType());
