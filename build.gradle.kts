...
tasks.test {
    useJUnitPlatform {
        includeTags("wall-placement", "floating-gift", "map-marker", "autonomy", "schedule", "tourist", "entity", "town", "crossmod", "worldnpc", "raid", "questboard", "construction", "quest", "bard", "prop")
    }
    systemProperty(
