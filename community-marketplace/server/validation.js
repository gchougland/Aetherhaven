/** @typedef {{ id: string, displayName: string, description?: string, creatorUuid: string, creatorName: string, styleId?: string, blockIdVersion: number, prefabBytes: number, version: string, approvedAt: string }} ApprovedEntry */
